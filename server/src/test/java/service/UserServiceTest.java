...
public class UserServiceTest {
    ...
    @Test
    void registerSameNameTwice() throws UnavailableException, DataAccessException {
    ...
    @Test
    void registerUser() throws UnavailableException, DataAccessException {
    ...
    @Test
    void clearUsers() throws UnavailableException, DataAccessException {
        registerUserRequest userInfo = new registerUserRequest("Isaac", "password", "hi@gmail.com");
    ...
    @Test
    void logInAndOut() throws UnavailableException, DataAccessException, InvalidAuthTokenException {
